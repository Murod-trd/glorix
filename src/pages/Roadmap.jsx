const roadmap = [
  ...
  {
    phase: 'MVP', status: 'next', color: '#63B3ED', period: 'Q3 2026 — 6 месяцев',
  ...
  {
    phase: 'Бета', status: 'planned', color: 'var(--gold)', period: 'Q1 2027 — 3 месяца',
  ...
  {
    phase: 'Production', status: 'planned', color: 'var(--text-2)', period: '2027',
