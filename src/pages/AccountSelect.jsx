...
const accounts = [
  ...
  },
  {
    ...
    desc: 'Продаю товары, участвую в тендерах как поставщик',
    can: ['Продажа в маркетплейсе', 'Участие в тендерах', 'Document Center', 'Аналитика продаж'],
    cannot: ['Создание тендеров', 'Покупка товаров'],
