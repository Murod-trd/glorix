...
const PRODUCT_TNVED_MAP = [
  ...
  { re: /^(плёнк|пленк).*(полиэтил|ПЭ|полиэт)/i,              code: '3920102500' }, // полиэтиленовая плёнка
  ...
  { re: /^(серпянк|стеклоткань.*лента|сетк.*строит)/i,         code: '7019610000' }, // серпянка стеклосетка
