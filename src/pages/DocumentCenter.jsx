...
const PRODUCT_TNVED_MAP = [
  ...
  { re: /^(отвод).*(металл|стал|чуг|Ду|ду|DN)/i,               code: '7307930000' }, // отводы стальные (elbows)
  { re: /^(тройник).*(металл|стал|чуг|Ду|ду|DN)/i,             code: '7307990000' }, // тройники стальные (tees)
  { re: /^(переход|муфта).*(металл|стал|Ду|ду)/i,              code: '7307990000' }, // переходы/муфты стальные
  ...
  { re: /^(бит[аыу]?|насадк).*(шуруп|дрел|шестигр|торцев)/i,   code: '8207900000' }, // биты и насадки
  ...
  { re: /^(ножниц|листов.*ножниц)/i,                            code: '8208100000' }, // ножницы по металлу (в т.ч. листовые)
  ...
  { re: /^(WD|WD-40|аэрозол|спрей)|(универс.*спрей)/i,         code: '3403110000' }, // WD-40, аэрозоли, спреи универсальные
