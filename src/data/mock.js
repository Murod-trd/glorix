...
export const tenders = [
  {
    id: 't1',
    title: 'Поставка пшеницы 3-го класса',
    ...
    deposit: { rate: 10, amount: 10000 },
    buyerCountry: 'UZ',
    createdAt: '2025-07-18',
  },
  {
    id: 't2',
    title: 'Закупка промышленных холодильных установок',
    category: 'Оборудование / Холодильное',
    status: 'agreement',
    deadline: '2025-08-30',
    ...
    deposit: { rate: 7.5, amount: 21000 },
    buyerCountry: 'KZ',
    createdAt: '2025-07-22',
  },
  {
    id: 't3',
    title: 'Поставка ноутбуков для корпоративного парка',
    category: 'IT / Электроника',
    status: 'completed',
    deadline: '2025-07-01',
  ...
  offers: [
    {
      ...
      trustScore: 91,
      incoterms: 'CIF',
      aiNote: 'Оптимальное соотношение цены и надёжности',
      recommended: true,
    },
    {
      id: 'o2',
      ...
      trustScore: 78,
      incoterms: 'FOB',
      aiNote: 'Низкая цена товара, но высокая доставка и длиннее срок',
      recommended: false,
    },
    {
      id: 'o3',
      ...
      trustScore: 95,
      incoterms: 'DAP',
      aiNote: 'Самая быстрая доставка, высокий рейтинг, цена выше',
      recommended: false,
    },
  ],
};
